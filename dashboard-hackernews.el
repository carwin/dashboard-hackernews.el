...
;; The original package located at https://github.com/hyakt/emacs-dashboard-hackernews
;; has fallen out of date and the original author hasn't made an update or
;; responded to the issue queue in 3+ years.
;; Rather than simply fixing it for my own use, I've decided to maintain the
;; package in a repository I have control of. Hayato, I hope you're living well
;; wherever you are.
;; -- Carwin
...
(defun dashboard-hackernews-insert (list-size)
  ...
  (dashboard-hackernews-insert-list "Hacker News:"
